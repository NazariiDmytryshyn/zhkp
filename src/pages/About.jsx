...
const contacts = [
  {
    color: "blue",
    label: "Адреса",
    value: "вул. Соборна, 24, м. Бровари",
    icon: (
      <svg
        viewBox="0 0 24 24"
        fill="none"
    ...
    <section className="page page-about">
      <div className="section-header">
        <div>
          ...
          <p>Ми забезпечуємо комфортне проживання мешканців вже 15 років</p>
        </div>
      </div>

      <div className="content-block">
        <p>
          ПП "Наш Дім" — це житлово-комунальне підприємство, яке забезпечує
          технічне обслуговування та управління житловим фондом міста Бровари. У
          нас працюють кваліфіковані спеціалісти з прибирання, технічного
          обслуговування, ремонту та благоустрою.
        </p>
        <p>
          Наша мета — швидко реагувати на заявки мешканців, підтримувати будівлі
          та прибудинкову територію в належному стані, надавати прозору
          інформацію про плановані та виконані роботи. Ми дбаємо про кожен
          будинок як про власний.
        </p>
      </div>
